    ...
    <div className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20'>
      {/* ------Left Side ------- */}
        <div>
            ...
            <p className='my-6 text-[15px] text-gray-500'>  Effortlessly delete backgrounds from your photos in seconds using AI. <br /> No design skills needed — just upload your image and let us do the magic.</p>
            <div>
